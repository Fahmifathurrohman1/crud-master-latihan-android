package com.example.trainning.activity.ui.tambahTraining;
...
import com.example.trainning.model.ResponseErrorModel;
import com.example.trainning.rest.ApiConfig;
import com.example.trainning.rest.ApiService;
...
public class TambahTrainingViewModel extends ViewModel {
    ...
    private void postDataTraining(String kode_training, String nama_training, String type_training, String kuota_training, String harga_training, String
            tanggal_training, String gambar_training) {
        ApiService apiService = ApiConfig.getApiService();
        apiService.postTambahTraining(kode_training, nama_training, type_training, kuota_training, harga_training, tanggal_training, gambar_training)
